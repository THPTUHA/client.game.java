      ...
      if (/^image\//.test(file.type)) {
        ...
        try {
          const res = await axios.post(
            `${process.env.REACT_APP_SERVER}/admin/news/image`,
            formData
          );
                  ...
                  {({
                    ...
                    <div className="upload__image-wrapper">
                      <button
                        ...
                        } text-base outline-none focus:outline-none outline-none w-20 focus:outline-none bg-primary text-white flex items-center justify-center py-1 rounded font-medium mt-3 shadow `}
