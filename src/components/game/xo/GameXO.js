...
function GameXO({user}){
    ...
    function creactMap(board){
     ...
     function connect(id_match) {
         var socket = new SockJS('https://4643-2402-800-61b3-a7ce-9d7b-602-3b25-1b02.ngrok.io/gameplay');
    ...
    const submitForm = async ()=>{
      try{
        ans = await axios.post("https://4643-2402-800-61b3-a7ce-9d7b-602-3b25-1b02.ngrok.io/xo/start",{id_user:user.id});
